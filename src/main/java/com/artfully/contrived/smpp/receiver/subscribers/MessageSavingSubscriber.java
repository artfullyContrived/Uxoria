...
/**
 * Called on receipt of a new message. This class is responsible for persisting
 * the incoming message to DB. THE saveToDb method is called for every incoming
 * message
 */
