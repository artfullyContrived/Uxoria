...
/**
 * This is a callback for incoming messages. New Messages are received here then
 * the subscribers informed We then proceed to log the message and Convert to
 * HTTPRequest
 */
